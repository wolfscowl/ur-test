    ...
    val script = """
        def unnamed2():
            ...
            def twofg_release(width,force,speed,external_release=True,tool_index=0,blocking=True):
                local retVal=0
                retVal=twofg_grip(width+0.0,force,speed,external_release,tool_index,blocking)
                return retVal
            end 
            ...
            twofg_grip(width=0.0, force=40, speed=50, external_grip=True, tool_index=0)
